...
CREATE TABLE gHospital (
    id INT(10) UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT,
    encryptedSymbol TEXT,
    hName TEXT NOT NULL,
    typeCode INT(20) NOT NULL,
    typeName TEXT NOT NULL,
    areaCode INT(20) NOT NULL,
    areaName TEXT NOT NULL,
    addrCode INT(20) NOT NULL,
    addrName TEXT NOT NULL,
    detailArea TEXT NOT NULL,
    zipCode INT(20) NOT NULL,
    address TEXT NOT NULL,
    hNumber TEXT NOT NULL,
    hHomepage TEXT,
    openedYear INT(20) NOT NULL,
    `x` DOUBLE,
    `y` DOUBLE
);
